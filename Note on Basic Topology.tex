...
\end{exercise}
\begin{proof}
(1) Let $f$ be continuous. We need to prove that if $G_f\ni (x_k,y_k)\to (x_0,y_))$, then $(x_0,y_)\in G_f$. We have $(x_k,y_k)\in G_f$, then $y_k = f(x_k)$. Now we have $x_k\to x_0\in \mathbb{R}$, then $f(x_k)\to y_0$. Since $f$ is continuous, then $f(x_k)\to f(x_0)$. Hence $y_0 = f(x_0)$ and therefore $(x_0,y_0) = (x_0, f(x_0)) \in G_f$. \\
